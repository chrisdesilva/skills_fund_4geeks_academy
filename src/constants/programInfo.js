...
export const leadContent = {
	...
	paragraph: `${schoolName} offers full-time and part-time Full-Stack Software Development programs to help students learn to code on any schedule. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
